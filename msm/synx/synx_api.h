...
enum synx_client_id {
	...
	/*
	 * NOTE:
	 * HW fence client IDs from GFX_CTX0 .. IFE15_CTX0 are intentionally
	 * not re-declared here because hw_fence exports those enumerators in
	 * msm_hw_fence_synx_translation.h. Re-declaring them causes enum
	 * redefinition errors when both headers are included in the same TU.
	 *
	 * The skipped range is:
	 *   GFX_CTX0, IPE_CTX0, VID_CTX0, DPU0_CTL0, DPU1_CTL0,
	 *   IFE0_CTX0 .. IFE15_CTX0
	 * i.e. 21 slots of SYNX_MAX_SIGNAL_PER_CLIENT each.
	 */
	SYNX_CLIENT_HW_FENCE_TEST_CTX0 =
		SYNX_HW_FENCE_CLIENT_START + (21 * SYNX_MAX_SIGNAL_PER_CLIENT),
